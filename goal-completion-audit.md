...
| OpenClaw Bridge artifact | Partial | Local skeleton exists with identity adapter, Dify client, session/job API draft, job events SSE draft, default-disabled Gateway chat adapter contract, job flow utilities and tests. Not production complete. |
