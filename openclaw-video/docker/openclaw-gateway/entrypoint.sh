...
export DOUYIN_CHONG_PYTHONPATH="${DOUYIN_CHONG_PYTHONPATH:-/app/vendor}"
export MAX_DOWNLOAD_BYTES="${MAX_DOWNLOAD_BYTES:-536870912}"
export MAX_VIDEO_DURATION_SECONDS="${MAX_VIDEO_DURATION_SECONDS:-300}"
export MAX_VIDEO_FRAMES="${MAX_VIDEO_FRAMES:-6000}"
