...
export MAX_DOWNLOAD_BYTES="${MAX_DOWNLOAD_BYTES:-524288000}"
export MAX_VIDEO_DURATION_SECONDS="${MAX_VIDEO_DURATION_SECONDS:-0}"
export MAX_VIDEO_FRAMES="${MAX_VIDEO_FRAMES:-0}"
