...
class BridgeAppTests(unittest.TestCase):
    ...
    def test_openclaw_lab_page_is_served_without_gateway_secret_surface(self):
        ...
        self.assertIn("Diagnostics & Acceptance", response.text)
        self.assertIn("source-tabs", response.text)
        self.assertIn("linkSourceTab", response.text)
        self.assertIn("uploadSourceTab", response.text)
        ...
        self.assertIn("Sanitized JSON response", response.text)
        self.assertIn("Check Link", response.text)
        self.assertIn("Analyze Video", response.text)
        self.assertIn("Refresh Status", response.text)
        self.assertIn("Analyze Upload", response.text)
        self.assertIn("Tiny Upload Check", response.text)
        ...
        self.assertIn("Server-side URL validation runs", response.text)
        ...
        self.assertIn("setSourceMode('link')", response.text)
        self.assertIn("setSourceMode('upload')", response.text)
        ...
        self.assertIn("Video File", response.text)
