...
COLLECTING_INTENT_REPLY = (
    "可以。你现在有两个方向：\n"
    "1. 如果已经有视频，直接发抖音/TikTok/B 站单条视频链接，我先帮你拆问题和改法；\n"
...
_ERROR_REPLIES: dict[str, str] = {
    ...
    "url_rejected": (
        "这个链接没通过安全校验，可能不是有效的抖音/TikTok/B 站单条视频链接。\n"
        "请发单条视频页链接，不要发主页、合集页或其他暂未支持的平台链接。"
    ),
    "tool_failed": (
        "这个链接我暂时没有成功解析，所以我不会假装已经看过视频。\n"
        "你可以试一下：\n"
        "1. 发抖音/TikTok/B 站单条视频页链接，而不是主页或合集链接；\n"
        "2. 确认视频没有被删除或设为私密；\n"
...
_ERROR_FALLBACK = (
    ...
    "你可以换一条抖音/TikTok/B 站单条视频链接重试，或描述一下视频内容，我先帮你判断方向。"
)
