...
export type AgentDefaultsConfig = {
  ...
  /** Max concurrent agent runs across all conversations. Default: 1000. */
  ...
  subagents?: {
    ...
    allowAgents?: string[];
    /** Max concurrent sub-agent runs (global lane: "subagent"). Default: 1000. */
    maxConcurrent?: number;
    /** Maximum depth allowed for sessions_spawn chains. Default behavior: 1 (no nested spawns). */
    maxSpawnDepth?: number;
    /** Maximum active children a single requester session may spawn. Default behavior: 1000. */
