...
if grep -E '0\.0\.0\.0:18789|0\.0\.0\.0:5432|/var/run/docker\.sock|internal: true|--token' /tmp/openclaw-video-compose.rendered.yaml; then
...
grep -q 'ws://openclaw-gateway:18789' /tmp/openclaw-video-compose.rendered.yaml
